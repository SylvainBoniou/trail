...
if selected == "Coureurs":
    ...
    if df_coureurs.empty:
        ...
        st.markdown("<p class=\"big-font\">*Résultats basés sur les 9 dernières années pour l'UTMB et les 6 dernières années pour la diagonale des fous.</p>", unsafe_allow_html=True)
